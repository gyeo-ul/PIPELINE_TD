...
class Login(QWidget):
    def __init__(self):
        ...
        # UI 경로 설정 
        ui_file_path = '/run/media/rapa/server_wj/login_winter/login_v2.ui' # 본인 경로로 변경
        ...
        self.status_label = self.ui.findChild(QLabel, 'statusLabel')  # Added to connect statusLabel
    ...
    def open_loader(self, email):
        ...
        # 현재 로그인 창 닫기
        self.close()  # Changed to self.close()
